  ...
  <footer class="bg-white dark:bg-[#0e0e0e]">
    ...
    >
      <div class="flex justify-center space-x-6 md:order-2">
        <NuxtLink
          to="/"
          class="inline-flex items-center space-x-2 text-gray-700  hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-100"
        >
          <svg
        ...
        <a
          href="#"
          class="text-gray-700  hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-100"
        >
