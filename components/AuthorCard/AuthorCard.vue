<template>
  <div
    class="w-full p-3 my-6 rounded-lg shadow-md  md:p-6 md:flex md:space-x-6 bg-gray-50 dark:bg-gray-800"
  >
    ...
    <div class="md:w-5/6">
      <h2
        class="py-2 text-xl font-bold text-center  md:text-left md:text-3xl dark:text-white"
      >
        Hi! I'm Patrick Joannisse
      </h2>
      <p class="text-center dark:text-gray-400 md:text-left">
        I'm a Full Stack web developer specialized in web accessibility. Lorem
