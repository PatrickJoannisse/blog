<template>
  <section>
    <header class="max-w-screen-lg px-2 py-4 mx-auto">
      ...
      <div class="my-4 text-sm">
        <div class="flex space-x-6 lg:inline-flex lg:w-auto">
          ...
          <a
            :href="editUrl"
            class="inline-flex items-center space-x-2 transition duration-150  dark:text-gray-300 dark:hover:text-white hover:underline"
          >
            <span>Edit me</span>
            <svg
              class="w-4 h-auto fill-inherit"
              viewBox="0 0 15 15"
              fill="none"
...
export default {
  ...
  computed: {
    editUrl() {
      return `https://github.com/PatrickJoannisse/blog/blob/master/content/articles/${this.$nuxt._route.params.slug}.md`;
    },
  },
  head() {
    return {
